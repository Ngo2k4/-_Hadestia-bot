...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
 ...
 let pathImg = __dirname + "/cache/LeiamNash.jpg";
  ...
  var id1 = event.senderID;
    ...
    const leiamnash = await axios.get(`https://api.leiamnash.repl.co/leiamnash3`);
  let leiamnashh = leiamnash.data.image;
   /* var background = [
"https://i.imgur.com/UK0DnyL.jpg",
"https://i.imgur.com/wHyiHrl.jpg",
  ];
    var rd = background[Math.floor(Math.random() * 2) + 1];*/
    let getAvtmot = (
