...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`FujimaruBot`, '[ Fujimaru ]');
        logger('Hey, thank you for using this Bot', '[ FujimaruBot ]');
        logger("Fixed by Lance Fujimaru", '[ Fujimaru ]');
        logger("FB: facebook.com/lance.fujimaru", 'Fixed by Lance Fujimaru');
      var cron = require("node-cron");
